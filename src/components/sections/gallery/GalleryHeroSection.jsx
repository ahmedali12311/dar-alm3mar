...
export default function GalleryHeroSection() {
  return (
    <section className="relative flex flex-col items-center justify-center overflow-hidden bg-[#f4f0e8] pt-40 pb-20">
      <div className={`${containerClass} flex flex-col items-center z-10`}>
        ...
        >
          <div className="flex items-center justify-center gap-3 mb-6">
            <span className="h-px w-12 bg-[#915025]" />
            <span className="text-[11px] font-black uppercase tracking-[0.5em] text-[#915025]">
              معرض الأعمال المنفذة
            </span>
            <span className="h-px w-12 bg-[#915025]" />
          </div>
          <h1 className="font-['Cairo'] text-4xl font-black text-slate-900 md:text-6xl mb-6 leading-tight">
            مشاريع تحاكي <br/><span className="text-[#915025]">الواقع</span>
          </h1>
